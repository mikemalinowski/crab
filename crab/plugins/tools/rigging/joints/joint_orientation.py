...
class MoveRotationsToOrientsTool(crab.RigTool):
    ...
    tooltips = dict(
        mirror_plane='Moves any rotations on the normal X,Y,Z channels to the joint orient channels',
    )
...
class MoveOrientsToRotationsTool(crab.RigTool):
    ...
    tooltips = dict(
        mirror_plane='Moves any rotations on the joint orient channels to the normal X,Y,Z channels',
    )
