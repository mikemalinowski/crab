...
#             shape="config",
#             lock_list="sx;sy;sz;tx;ty;tz;tz;rx;ry;rz",
#             hide_list="sx;sy;sz;tx;ty;tz;tz;rx;ry;rz;v",
#         )
#         self._config_control.addAttr("ik_fk", at="float", dv=0, k=True, min=0, max=1)
#         self._config_control.addAttr("show_ik", at="float", dv=1, k=True, min=0, max=1)
#         self._config_control.addAttr("show_fk", at="float", dv=0, k=True, min=0, max=1)
#
...
#             shape="paddle",
#         )
#         self._config_control.attr("show_ik").connect(self._upper_joint_manipulator.attr("visibility"))
#
...
#             shape="foot"
#         )
#         self._config_control.attr("show_ik").connect(self._foot_control.attr("visibility"))
#
...
#             shape="sphere"
#         )
#         self._config_control.attr("show_ik").connect(self._foot_tip_control.attr("visibility"))
#
...
#         )
#         self._config_control.attr("show_ik").connect(self._reverse_foot_control.attr("visibility"))
#
...
#             hide_list="tx;ty;tz;sx;sy;sz;v",
#         )
#         self._config_control.attr("show_ik").connect(self._toe_control.attr("visibility"))
#
...
#             shape="sphere",
#         )
#         self._config_control.attr("show_ik").connect(self._ankle_upv_control.attr("visibility"))
#
...
#         )
#
#         self._config_control.attr("show_ik").connect(self._knee_upv_control.attr("visibility"))
#
...
#             )
#             self._config_control.attr("show_fk").connect(fk_control.attr("visibility"))
#
...
#             self._config_control.attr("ik_fk").connect(reverse_node.inputX)
#             reverse_node.outputX.connect(cns.getWeightAliasList()[0])
#
#             # -- Hook up the FK constraint blend, which is direct
#             self._config_control.attr("ik_fk").connect(cns.getWeightAliasList()[1])
#
...
#
#         # -- Create the ankle solver upvector pivot - this allows the pivot
#         # -- to be zero"d before being driven
#         ankle_piv_org = crab.create.generic(
#             node_type="transform",
#             prefix=crab.config.ORG,
#             description="{}Ankle".format(self.options.description),
#             side=self.options.side,
#             parent=self._foot_tip_control,
...
#
#         # -- Create the spring solver upvector pivot - this allows the pivot
#         #         # -- to be zero"d before being driven
#         knee_piv_org = crab.create.generic(
#             node_type="transform",
#             prefix=crab.config.ORG,
